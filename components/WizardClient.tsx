        ...
        <form action={onSingle} className="grid md:grid-cols-3 gap-3 items-end mt-4">
          ...
          {(singleResult || singleError) && (
            <div className="md:col-span-3 grid gap-2">
              {singleResult && (
                <div className="inline-block max-w-full rounded-xl border border-emerald-600/30 bg-emerald-600/10 text-emerald-900 dark:border-emerald-400/30 dark:bg-emerald-400/10 dark:text-emerald-50 text-sm px-3 py-2">
                  <div className="flex items-center gap-2">
